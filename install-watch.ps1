...
$ApkUrl = "https://github.com/sdvirk-tech/health-connect-drive-export/raw/cursor/watch-vitals-export-8125/dist/HealthSync-wear-0.3.7-debug.apk"
...
function Get-WearApk {
    ...
    $dest = Join-Path $distDir "HealthSync-wear-0.3.7-debug.apk"
